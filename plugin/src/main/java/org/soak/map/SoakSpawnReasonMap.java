...
public class SoakSpawnReasonMap {
    ...
    public static DefaultedRegistryReference<SpawnType> toSponge(CreatureSpawnEvent.SpawnReason reason) {
        return switch (reason) {
            case BEEHIVE, SPAWNER -> SpawnTypes.MOB_SPAWNER;
            ...
            case COMMAND, MOUNT, CURED, TRAP, RAID, CUSTOM, DROWNED, DUPLICATION, ENDER_PEARL, FROZEN, INFECTION, JOCKEY, LIGHTNING, METAMORPHOSIS, NATURAL, NETHER_PORTAL, PATROL, PIGLIN_ZOMBIFIED, REINFORCEMENTS, SHEARED, SHOULDER_ENTITY, SLIME_SPLIT, SPELL, VILLAGE_DEFENSE, VILLAGE_INVASION ->
                    SpawnTypes.CUSTOM;
            case DISPENSE_EGG -> SpawnTypes.DISPENSE;
            case DEFAULT -> SpawnTypes.WORLD_SPAWNER;
