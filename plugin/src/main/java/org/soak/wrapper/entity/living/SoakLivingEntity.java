...
public class SoakLivingEntity<E extends Living> extends SoakEntity<E> implements SoakDamageable, SoakAttributable, SoakProjectileSource, LivingEntity {

    public SoakLivingEntity(Subject subject, Audience audience, E entity) {
    ...
    public RayTraceResult rayTraceBlocks(double arg0, @NotNull FluidCollisionMode arg1) {
        throw NotImplementedException.createByLazy(LivingEntity.class, "rayTraceBlocks", double.class, FluidCollisionMode.class);
    }
    ...
    public void playPickupItemAnimation(@NotNull Item arg0, int arg1) {
        throw NotImplementedException.createByLazy(LivingEntity.class, "playPickupItemAnimation", Item.class, int.class);
    }
    ...
    public @Nullable Block getTargetBlock(int maxDistance, TargetBlockInfo.@NotNull FluidMode fluidMode) {
        throw NotImplementedException.createByLazy(LivingEntity.class, "getTargetBlockExact", int.class, FluidCollisionMode.class);
    }

    @Override
    public @Nullable BlockFace getTargetBlockFace(int maxDistance, @NotNull TargetBlockInfo.FluidMode fluidMode) {
        throw NotImplementedException.createByLazy(LivingEntity.class, "getTargetBlockFace", int.class, TargetBlockInfo.FluidMode.class);
    }

    @Override
    public @Nullable TargetBlockInfo getTargetBlockInfo(int maxDistance, @NotNull TargetBlockInfo.FluidMode fluidMode) {
        throw NotImplementedException.createByLazy(LivingEntity.class, "getTargetBlockInfo", int.class, TargetBlockInfo.FluidMode.class);
    }
    ...
    public boolean addPotionEffect(@NotNull PotionEffect arg0, boolean arg1) {
        throw NotImplementedException.createByLazy(LivingEntity.class, "addPotionEffect", PotionEffect.class, boolean.class);
    }
