...
public class SoakWorld implements World {
    ...
    public @NotNull Block getBlockAt(@NotNull Location arg0) {
        throw NotImplementedException.createByLazy(World.class, "getBlockAt", Location.class);
    }

    @Override
    public @NotNull Block getBlockAt(int arg0, int arg1, int arg2) {
        throw NotImplementedException.createByLazy(World.class, "getBlockAt", int.class, int.class, int.class);
    }

    @Override
    public int getHighestBlockYAt(int arg0, int arg1) {
        throw NotImplementedException.createByLazy(World.class, "getHighestBlockYAt", int.class, int.class);
    }

    @Override
    public int getHighestBlockYAt(@NotNull Location arg0) {
        throw NotImplementedException.createByLazy(World.class, "getHighestBlockYAt", Location.class);
    }
    ...
    public int getHighestBlockYAt(int arg0, int arg1, @NotNull HeightMap arg2) {
        throw NotImplementedException.createByLazy(World.class, "getHighestBlockYAt", int.class, int.class, HeightMap.class);
    }

    @Deprecated
    @Override
    public int getHighestBlockYAt(int arg0, int arg1, HeightmapType arg2) {
        throw NotImplementedException.createByLazy(World.class, "getHighestBlockYAt", int.class, int.class, HeightmapType.class);
    }
    ...
    public @NotNull Block getHighestBlockAt(int arg0, int arg1, @NotNull HeightMap arg2) {
        throw NotImplementedException.createByLazy(World.class, "getHighestBlockAt", int.class, int.class, HeightMap.class);
    }
    ...
    public @NotNull Collection<Entity> getNearbyEntities(@NotNull Location location, double x, double y, double z) {
        throw NotImplementedException.createByLazy(World.class, "getNearbyEntities", Location.class, double.class, double.class, double.class);
    }
    ...
    public boolean createExplosion(Entity arg0, @NotNull Location arg1, float arg2, boolean arg3, boolean arg4) {
        throw NotImplementedException.createByLazy(World.class, "createExplosion", Entity.class, Location.class, float.class, boolean.class, boolean.class);
    }

    @Override
    public boolean createExplosion(double arg0, double arg1, double arg2, float arg3) {
        throw NotImplementedException.createByLazy(World.class, "createExplosion", double.class, double.class, double.class, float.class);
    }

    @Override
    public boolean createExplosion(@NotNull Location arg0, float arg1, boolean arg2) {
        throw NotImplementedException.createByLazy(World.class, "createExplosion", Location.class, float.class, boolean.class);
    }

    @Override
    public boolean createExplosion(double arg0, double arg1, double arg2, float arg3, boolean arg4, boolean arg5) {
        throw NotImplementedException.createByLazy(World.class, "createExplosion", double.class, double.class, double.class, float.class, boolean.class, boolean.class);
    }

    @Override
    public boolean createExplosion(double arg0, double arg1, double arg2, float arg3, boolean arg4) {
        throw NotImplementedException.createByLazy(World.class, "createExplosion", double.class, double.class, double.class, float.class, boolean.class);
    }

    @Override
    public boolean createExplosion(double arg0, double arg1, double arg2, float arg3, boolean arg4, boolean arg5, Entity arg6) {
        throw NotImplementedException.createByLazy(World.class, "createExplosion", double.class, double.class, double.class, float.class, boolean.class, boolean.class, Entity.class);
    }
    ...
    public boolean createExplosion(@NotNull Location arg0, float arg1, boolean arg2, boolean arg3, Entity arg4) {
        throw NotImplementedException.createByLazy(World.class, "createExplosion", Location.class, float.class, boolean.class, boolean.class, Entity.class);
    }

    @Override
    public boolean createExplosion(@NotNull Location arg0, float arg1, boolean arg2, boolean arg3) {
        throw NotImplementedException.createByLazy(World.class, "createExplosion", Location.class, float.class, boolean.class, boolean.class);
    }

    @Override
    public <T extends Entity> @NotNull T spawn(@NotNull Location location, @NotNull Class<T> clazz) throws IllegalArgumentException {
        throw NotImplementedException.createByLazy(World.class, "spawn", Location.class, Class.class);
    }
    ...
    public <T extends Entity> @NotNull T spawn(@NotNull Location location, @NotNull Class<T> clazz, @Nullable Consumer<T> function, @NotNull CreatureSpawnEvent.SpawnReason reason) throws IllegalArgumentException {
        throw NotImplementedException.createByLazy(World.class, "spawn", Location.class, Class.class, Consumer.class, CreatureSpawnEvent.SpawnReason.class);
    }
    ...
    public void spawnParticle(@NotNull Particle arg0, List arg1, Player arg2, double arg3, double arg4, double arg5, int arg6, double arg7, double arg8, double arg9, double arg10, Object arg11, boolean arg12) {
        throw NotImplementedException.createByLazy(World.class, "spawnParticle", Particle.class, List.class, Player.class, double.class, double.class, double.class, int.class, double.class, double.class, double.class, double.class, Object.class, boolean.class);
    }
    ...
    public void spawnParticle(@NotNull Particle arg0, @NotNull Location arg1, int arg2, double arg3, double arg4, double arg5, double arg6, Object arg7, boolean arg8) {
        throw NotImplementedException.createByLazy(World.class, "spawnParticle", Particle.class, Location.class, int.class, double.class, double.class, double.class, double.class, Object.class, boolean.class);
    }

    @Override
    public void spawnParticle(@NotNull Particle arg0, @NotNull Location arg1, int arg2) {
        throw NotImplementedException.createByLazy(World.class, "spawnParticle", Particle.class, Location.class, int.class);
    }

    @Override
    public void spawnParticle(@NotNull Particle arg0, @NotNull Location arg1, int arg2, double arg3, double arg4, double arg5) {
        throw NotImplementedException.createByLazy(World.class, "spawnParticle", Particle.class, Location.class, int.class, double.class, double.class, double.class);
    }
    ...
    public void spawnParticle(@NotNull Particle arg0, double arg1, double arg2, double arg3, int arg4, double arg5, double arg6, double arg7) {
        throw NotImplementedException.createByLazy(World.class, "spawnParticle", Particle.class, double.class, double.class, double.class, int.class, double.class, double.class, double.class);
    }
    ...
    public void spawnParticle(@NotNull Particle arg0, @NotNull Location arg1, int arg2, double arg3, double arg4, double arg5, Object arg6) {
        throw NotImplementedException.createByLazy(World.class, "spawnParticle", Particle.class, Location.class, int.class, double.class, double.class, double.class, Object.class);
    }

    @Override
    public void spawnParticle(@NotNull Particle arg0, double arg1, double arg2, double arg3, int arg4, Object arg5) {
        throw NotImplementedException.createByLazy(World.class, "spawnParticle", Particle.class, double.class, double.class, double.class, int.class, Object.class);
    }

    @Override
    public void spawnParticle(@NotNull Particle arg0, @NotNull Location arg1, int arg2, Object arg3) {
        throw NotImplementedException.createByLazy(World.class, "spawnParticle", Particle.class, Location.class, int.class, Object.class);
    }

    @Override
    public void spawnParticle(@NotNull Particle arg0, double arg1, double arg2, double arg3, int arg4) {
        throw NotImplementedException.createByLazy(World.class, "spawnParticle", Particle.class, double.class, double.class, double.class, int.class);
    }
    ...
    public void spawnParticle(@NotNull Particle arg0, double arg1, double arg2, double arg3, int arg4, double arg5, double arg6, double arg7, double arg8) {
        throw NotImplementedException.createByLazy(World.class, "spawnParticle", Particle.class, double.class, double.class, double.class, int.class, double.class, double.class, double.class, double.class);
    }
    ...
    public void spawnParticle(@NotNull Particle arg0, @NotNull Location arg1, int arg2, double arg3, double arg4, double arg5, double arg6, Object arg7) {
        throw NotImplementedException.createByLazy(World.class, "spawnParticle", Particle.class, Location.class, int.class, double.class, double.class, double.class, double.class, Object.class);
    }
    ...
    public void spawnParticle(@NotNull Particle arg0, double arg1, double arg2, double arg3, int arg4, double arg5, double arg6, double arg7, Object arg8) {
        throw NotImplementedException.createByLazy(World.class, "spawnParticle", Particle.class, double.class, double.class, double.class, int.class, double.class, double.class, double.class, Object.class);
    }
    ...
    public void spawnParticle(@NotNull Particle arg0, @NotNull Location arg1, int arg2, double arg3, double arg4, double arg5, double arg6) {
        throw NotImplementedException.createByLazy(World.class, "spawnParticle", Particle.class, Location.class, int.class, double.class, double.class, double.class, double.class);
    }
    ...
    public void spawnParticle(@NotNull Particle arg0, double arg1, double arg2, double arg3, int arg4, double arg5, double arg6, double arg7, double arg8, Object arg9, boolean arg10) {
        throw NotImplementedException.createByLazy(World.class, "spawnParticle", Particle.class, double.class, double.class, double.class, int.class, double.class, double.class, double.class, double.class, Object.class, boolean.class);
    }
    ...
    public void setChunkForceLoaded(int arg0, int arg1, boolean arg2) {
        throw NotImplementedException.createByLazy(World.class, "setChunkForceLoaded", int.class, int.class, boolean.class);
    }
    ...
    public boolean addPluginChunkTicket(int arg0, int arg1, @NotNull Plugin arg2) {
        throw NotImplementedException.createByLazy(World.class, "addPluginChunkTicket", int.class, int.class, Plugin.class);
    }

    @Override
    public boolean removePluginChunkTicket(int arg0, int arg1, @NotNull Plugin arg2) {
        throw NotImplementedException.createByLazy(World.class, "removePluginChunkTicket", int.class, int.class, Plugin.class);
    }
    ...
    public @NotNull Item dropItem(@NotNull Location location, @NotNull ItemStack item, @Nullable Consumer<Item> function) {
        throw NotImplementedException.createByLazy(World.class, "dropItem", Location.class, ItemStack.class, Consumer.class);
    }
    ...
    public <T extends AbstractArrow> @NotNull T spawnArrow(@NotNull Location location, @NotNull Vector direction, float speed, float spread, @NotNull Class<T> clazz) {
        throw NotImplementedException.createByLazy(World.class, "spawnArrow", Location.class, Vector.class, float.class, float.class, Class.class);
    }

    @Override
    public @NotNull Arrow spawnArrow(@NotNull Location arg0, @NotNull Vector arg1, float arg2, float arg3) {
        throw NotImplementedException.createByLazy(World.class, "spawnArrow", Location.class, Vector.class, float.class, float.class);
    }

    @Override
    public boolean generateTree(@NotNull Location arg0, @NotNull TreeType arg1, @NotNull BlockChangeDelegate arg2) {
        throw NotImplementedException.createByLazy(World.class, "generateTree", Location.class, TreeType.class, BlockChangeDelegate.class);
    }
    ...
    public @NotNull Entity spawnEntity(@NotNull Location arg0, @NotNull EntityType arg1) {
        throw NotImplementedException.createByLazy(World.class, "spawnEntity", Location.class, EntityType.class);
    }
    ...
    public RayTraceResult rayTraceEntities(@NotNull Location arg0, @NotNull Vector arg1, double arg2) {
        throw NotImplementedException.createByLazy(World.class, "rayTraceEntities", Location.class, Vector.class, double.class);
    }

    @Override
    public RayTraceResult rayTraceEntities(@NotNull Location arg0, @NotNull Vector arg1, double arg2, double arg3, Predicate arg4) {
        throw NotImplementedException.createByLazy(World.class, "rayTraceEntities", Location.class, Vector.class, double.class, double.class, Predicate.class);
    }

    @Override
    public RayTraceResult rayTraceEntities(@NotNull Location arg0, @NotNull Vector arg1, double arg2, Predicate arg3) {
        throw NotImplementedException.createByLazy(World.class, "rayTraceEntities", Location.class, Vector.class, double.class, Predicate.class);
    }

    @Override
    public RayTraceResult rayTraceEntities(@NotNull Location arg0, @NotNull Vector arg1, double arg2, double arg3) {
        throw NotImplementedException.createByLazy(World.class, "rayTraceEntities", Location.class, Vector.class, double.class, double.class);
    }

    @Override
    public RayTraceResult rayTraceBlocks(@NotNull Location arg0, @NotNull Vector arg1, double arg2) {
        throw NotImplementedException.createByLazy(World.class, "rayTraceBlocks", Location.class, Vector.class, double.class);
    }
    ...
    public RayTraceResult rayTraceBlocks(@NotNull Location arg0, @NotNull Vector arg1, double arg2, @NotNull FluidCollisionMode arg3, boolean arg4) {
        throw NotImplementedException.createByLazy(World.class, "rayTraceBlocks", Location.class, Vector.class, double.class, FluidCollisionMode.class, boolean.class);
    }
    ...
    public RayTraceResult rayTraceBlocks(@NotNull Location arg0, @NotNull Vector arg1, double arg2, @NotNull FluidCollisionMode arg3) {
        throw NotImplementedException.createByLazy(World.class, "rayTraceBlocks", Location.class, Vector.class, double.class, FluidCollisionMode.class);
    }
    ...
    public RayTraceResult rayTrace(@NotNull Location arg0, @NotNull Vector arg1, double arg2, @NotNull FluidCollisionMode arg3, boolean arg4, double arg5, Predicate arg6) {
        throw NotImplementedException.createByLazy(World.class, "rayTrace", Location.class, Vector.class, double.class, FluidCollisionMode.class, boolean.class, double.class, Predicate.class);
    }
    ...
    public boolean setSpawnLocation(int arg0, int arg1, int arg2, float arg3) {
        throw NotImplementedException.createByLazy(World.class, "setSpawnLocation", int.class, int.class, int.class, float.class);
    }
    ...
    public @NotNull Environment getEnvironment() {
        throw NotImplementedException.createByLazy(World.class, "getEnvironment");
    }
    ...
    public @NotNull FallingBlock spawnFallingBlock(@NotNull Location arg0, @NotNull MaterialData arg1) {
        throw NotImplementedException.createByLazy(World.class, "spawnFallingBlock", Location.class, MaterialData.class);
    }

    @Deprecated
    @Override
    public @NotNull FallingBlock spawnFallingBlock(@NotNull Location arg0, @NotNull Material arg1, byte arg2) {
        throw NotImplementedException.createByLazy(World.class, "spawnFallingBlock", Location.class, Material.class, byte.class);
    }
    ...
    public void playEffect(@NotNull Location arg0, @NotNull Effect arg1, Object arg2, int arg3) {
        throw NotImplementedException.createByLazy(World.class, "playEffect", Location.class, Effect.class, Object.class, int.class);
    }

    @Override
    public void playEffect(@NotNull Location arg0, @NotNull Effect arg1, Object arg2) {
        throw NotImplementedException.createByLazy(World.class, "playEffect", Location.class, Effect.class, Object.class);
    }

    @Override
    public void playEffect(@NotNull Location arg0, @NotNull Effect arg1, int arg2, int arg3) {
        throw NotImplementedException.createByLazy(World.class, "playEffect", Location.class, Effect.class, int.class, int.class);
    }

    @Override
    public @NotNull ChunkSnapshot getEmptyChunkSnapshot(int arg0, int arg1, boolean arg2, boolean arg3) {
        throw NotImplementedException.createByLazy(World.class, "getEmptyChunkSnapshot", int.class, int.class, boolean.class, boolean.class);
    }
    ...
    public void setBiome(int arg0, int arg1, int arg2, @NotNull Biome arg3) {
        throw NotImplementedException.createByLazy(World.class, "setBiome", int.class, int.class, int.class, Biome.class);
    }
    ...
    public void playSound(@NotNull Location arg0, @NotNull String arg1, float arg2, float arg3) {
        throw NotImplementedException.createByLazy(World.class, "playSound", Location.class, String.class, float.class, float.class);
    }

    @Override
    public void playSound(@NotNull Location arg0, @NotNull Sound arg1, @NotNull SoundCategory arg2, float arg3, float arg4) {
        throw NotImplementedException.createByLazy(World.class, "playSound", Location.class, Sound.class, SoundCategory.class, float.class, float.class);
    }

    @Override
    public void playSound(@NotNull Location arg0, @NotNull Sound arg1, float arg2, float arg3) {
        throw NotImplementedException.createByLazy(World.class, "playSound", Location.class, Sound.class, float.class, float.class);
    }

    @Override
    public void playSound(@NotNull Location arg0, @NotNull String arg1, @NotNull SoundCategory arg2, float arg3, float arg4) {
        throw NotImplementedException.createByLazy(World.class, "playSound", Location.class, String.class, SoundCategory.class, float.class, float.class);
    }
    ...
    public Location locateNearestStructure(@NotNull Location arg0, @NotNull StructureType arg1, int arg2, boolean arg3) {
        throw NotImplementedException.createByLazy(World.class, "locateNearestStructure", Location.class, StructureType.class, int.class, boolean.class);
    }

    @Override
    public Location locateNearestBiome(@NotNull Location arg0, @NotNull Biome arg1, int arg2) {
        throw NotImplementedException.createByLazy(World.class, "locateNearestBiome", Location.class, Biome.class, int.class);
    }

    @Override
    public Location locateNearestBiome(@NotNull Location arg0, @NotNull Biome arg1, int arg2, int arg3) {
        throw NotImplementedException.createByLazy(World.class, "locateNearestBiome", Location.class, Biome.class, int.class, int.class);
    }
    ...
    public @NotNull String getName() {
        return this.world.properties().displayName().map(com -> PlainTextComponentSerializer.plainText().serialize(com)).orElse(this.world.key().value());
    }
    ...
    public void sendPluginMessage(@NotNull Plugin source, @NotNull String channel, byte[] message) {
        throw NotImplementedException.createByLazy(SoakWorld.class, "sendPluginMessage", Plugin.class, String.class, byte[].class);
    }
