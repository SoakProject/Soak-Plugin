...
public class SoakPistonExtendEvent extends SoakEvent<NotifyNeighborBlockEvent, BlockPistonExtendEvent> {

    public SoakPistonExtendEvent(Class<BlockPistonExtendEvent> bukkitEvent, EventPriority priority, Plugin plugin,
